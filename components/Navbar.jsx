    ...
    <div className="fixed w-screen h-20 z-[100] ">
      <div className=" flex  mt-8 justify-center">
        <ul className="hidden md:flex  text-xl">
          <Link href="#">
            <li className="mr-20 bg-[#fd7e14] rounded-xl px-4 py-1 uppercase hover:border-b">
              Iphoundit
            </li>
          </Link>
          ...
          <Link href="/estate/Footer">
            <li className="ml-15 uppercase hover:border-b mr-4 bg-[#fd7e14] rounded-xl px-4 py-1 ">
              Contact
            </li>
          </Link>
        </ul>
      ...
      <div className=" flex md:hidden justify-between px-6">
        <p
          className="text-gray-800 font-bold text-3xl pb-6 pr-8 hover:cursor-pointer"
      ...
      >
        <div className="flex w-full items-center justify-between ">
          ...
          <div onClick={handleNav} className="   cursor-pointer mb-6 pl-12">
            <GrClose size={30} />
          </div>
        </div>
